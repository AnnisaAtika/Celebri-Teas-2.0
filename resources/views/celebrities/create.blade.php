                ...
                <div class="card-body">
                    <form action="{{route('celebrities:store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Star</label>
                            <input type="text" name="star" class="form-control" style="background-color:#FFF4F4; width:450px;">
                            @if ($errors->has('star'))
                        ...
                        <div class="form-group">
                            <label>Title 1</label>
                            <input type="text" name="title1" class="form-control" style="background-color:#FFF4F4;">
                        ...
                        <div class="form-group">
                            <label>Title 2</label>
                            <input type="text" name="title2" class="form-control" style="background-color:#FFF4F4;">
                        ...
                        <div class="form-group">
                            <label>Title 3</label>
                            <input type="text" name="title3" class="form-control" style="background-color:#FFF4F4;">
                        ...
                        <div class="form-group">
                            <label>Title 4</label>
                            <input type="text" name="title4" class="form-control" style="background-color:#FFF4F4;">
                        ...
                        <div class="col-md-12 text-center">
                            <button type="submit" class="btn btn-primary" style="width: 140px; margin: auto;  background-color: #C79C9C; border:none;">Save</button>
                            &nbsp;&nbsp;&nbsp;
